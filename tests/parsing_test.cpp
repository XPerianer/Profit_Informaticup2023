...
TEST(Parsing, ParseTaskFour) {
  auto expected = Input{
      ...
      .deposits = {Deposit{{0, 0}, {8, 9}, ResourceType::TYPE0},
                   ...
                   Deposit{{21, 14}, {8, 9}, ResourceType::TYPE3}},
      .obstacles = {Obstacle{{8, 0}, {4, 11}}, Obstacle{{8, 12}, {4, 11}},
                    Obstacle{{17, 0}, {4, 11}}, Obstacle{{17, 12}, {4, 11}},
                    Obstacle{{14, 10}, {1, 3}}, Obstacle{{12, 0}, {5, 1}},
                    Obstacle{{12, 22}, {5, 1}}},
  };
...
TEST(Input, DifferentOrdering) {
  auto input_a = Input{.dimensions = {10, 10},
                       ...
                       .products = {Product{ProductType::TYPE0, {10, 10, 0, 0, 0, 0, 0, 0}, 10},
                                    Product{ProductType::TYPE1, {0, 0, 10, 10, 0, 0, 0, 0}, 10}},
                       .deposits = {Deposit{{0, 0}, {8, 9}, ResourceType::TYPE0}},
                       .obstacles = {Obstacle{{8, 0}, {4, 11}}, Obstacle{{3, 12}, {15, 3}}}};
  auto input_b = Input{
      .dimensions = {10, 10},
      .turns = 50,
      .time = 120,
